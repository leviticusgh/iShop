	...
	<div class="span2">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li><a href="#"><i class="icon-group icon-large"></i> Cashiers <div class="pull-right"><i class="icon-circle-arrow-right icon-large"></i></div></a></li>
              ...
              <li><a href="#"><i class="icon-truck icon-large"></i> Suppliers <div class="pull-right"><i class="icon-circle-arrow-right icon-large"></i></div></a></li>
              ...
              <li><a href="sales.php"><i class="icon-inbox icon-large"></i> Cash <div class="pull-right"><i class="icon-circle-arrow-right icon-large"></i></div></a></li>
			   <!-- <li><a href="cashier.php"><i class="icon-group icon-large"></i> Cashiers <div class="pull-right"><i class="icon-circle-arrow-right icon-large"></i></div></a></li> -->
            </ul>
          </div><!--/.well -->
        </div><!--/span-->
	<div class="span10">
