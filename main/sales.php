...
<option></option>
	...
	?>
		<option value="<?php echo $row['product_id'];?>"><?php echo $row['product_name']; ?> - <?php echo $row['barcode']; ?> | <b>Measure: </b><?php echo $row['measure']; ?></option>
	<?php
				}
			?>
</select>
<input type="number" step="any" min="0" name="qty" placeholder="Qty" autocomplete="off" style="width: 68px; height:30px; padding-top:6px; padding-bottom: 4px; margin-right: 4px; font-size:15px;" required>
<input type="hidden" name="date" value="<?php date_default_timezone_get(); date_default_timezone_set("Africa/Accra"); echo date("Y-m-d H:i:s"); ?>" />
