...
{ 
  var disp_setting="toolbar=yes,location=no,directories=yes,menubar=yes,"; 
      disp_setting+="scrollbars=yes,width=1100, height=400, left=100, top=25"; 
  var content_vlue = document.getElementById("content").innerHTML; 
  
  var docprint=window.open("","",disp_setting); 
   docprint.document.open(); 
   docprint.document.write('</head><body onLoad="self.print()" style="width: 1100px; font-size:11px; font-family:arial; font-weight:normal;">');          
...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-bar-chart"></i> Sales Report - Pacewealth Ventures
			</div>
...
<div style="margin-top: -19px; margin-bottom: 21px;" class="noprint">
<a  href="index.php"><button class="btn btn-default btn-large" style="float: none;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
<a href="javascript:window.print()" ><button  style="float:right; width: 100px;" class="btn btn-success btn-mini"> Print</button></a>


</div>
<form action="salesreport.php" method="get">
<center class="noprint"><strong>From : <input type="datetime-local" style="width: 223px; padding:14px;+" name="d1" value="" /> To: <input type="datetime-local" style="width: 223px; padding:14px;" name="d2" value="" />
