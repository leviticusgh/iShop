...
<center>
<input type="text" size="50" value="" name="cname" class="" autocomplete="off" placeholder="Enter Customer Name" style="width: 268px; height:30px;" />
...
<input type="number" step="any" min="0" name="cash" placeholder="Cash" style="width: 268px; height:30px;  margin-bottom: 15px;"  required/><br>
<?php
}
