...
<?php include('navfixed.php');?>
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li class="active"><a href="purchaselist.php"><i class="icon-truck icon-2x"></i><br> Purchases </a></li>
...
<input type="text" name="filter" style="height:35px; margin-top: -1px;" value="" id="filter" placeholder="Search Purchases..." autocomplete="off" />
