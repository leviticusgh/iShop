...
<div class="container-fluid">
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; color:#000;"><center>Pacewealth Ventures</center></font>
<div id="mainmain">
...
<!-- <a href="cashier.php"><i class="icon-group icon-2x"></i><br> Cashiers</a>      -->
<!-- <a href="supplier.php"><i class="icon-truck icon-2x"></i><br> Suppliers</a>      -->
